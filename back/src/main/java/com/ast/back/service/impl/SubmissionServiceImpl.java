...
import com.ast.back.domain.submission.JavaSubmissionParser;
import com.ast.back.domain.submission.ParseOutcome;
...
import com.ast.back.service.dto.TextSubmissionEntry;
...
public class SubmissionServiceImpl implements SubmissionService {
    ...
    public Submission createTextSubmission(Long studentId, Long assignmentId, TextSubmissionRequest request) {
        ...
        List<MultipartFile> files = request.entries().stream()
    ...
    private MultipartFile toMultipartFile(TextSubmissionEntry entry) {
